...
class CodeGeneratorTest extends GroovyTestCase {
  ...
  void testPlusU() {
    ...
    GroovyTestCase.assertEquals(codeExpected, codeGen.compile(tokPlusU, 0))
  ...
  void testPlusB() {
    ...
    String codeExpected = ".start\npush.i 1\npush.i 2\nadd.i\nout.i\npush.i 10\nout.c\nhalt\n"
    CodeGenerator codeGen = new CodeGenerator()
    GroovyTestCase.assertEquals(codeExpected, codeGen.compile(tokPlusB, 0))
  ...
  void testMoinsU() {
    ...
    String codeExpected = ".start\npush.i 0\npush.i 1\nsub.i\nout.i\npush.i 10\nout.c\nhalt\n"
    CodeGenerator codeGen = new CodeGenerator()
    GroovyTestCase.assertEquals(codeExpected, codeGen.compile(tokMoinsU, 0))
  ...
  void testMoinsB() {
    ...
    String codeExpected = ".start\npush.i 1\npush.i 2\nsub.i\nout.i\npush.i 10\nout.c\nhalt\n"
    CodeGenerator codeGen = new CodeGenerator()
    GroovyTestCase.assertEquals(codeExpected, codeGen.compile(tokMoinsB, 0))
  ...
  void testMul() {
    ...
    String codeExpected = ".start\npush.i 1\npush.i 2\nmul.i\nout.i\npush.i 10\nout.c\nhalt\n"
    CodeGenerator codeGen = new CodeGenerator()
    GroovyTestCase.assertEquals(codeExpected, codeGen.compile(tokMul, 0))
  ...
  void testDiv() {
    ...
    String codeExpected = ".start\npush.i 1\npush.i 2\ndiv.i\nout.i\npush.i 10\nout.c\nhalt\n"
    CodeGenerator codeGen = new CodeGenerator()
    GroovyTestCase.assertEquals(codeExpected, codeGen.compile(tokDiv, 0))
  }
  ...
  void testMod() {
    ...
    String codeExpected = ".start\npush.i 1\npush.i 2\nmod.i\nout.i\npush.i 10\nout.c\nhalt\n"
    CodeGenerator codeGen = new CodeGenerator()
    GroovyTestCase.assertEquals(codeExpected, codeGen.compile(tokMod, 0))
  }
